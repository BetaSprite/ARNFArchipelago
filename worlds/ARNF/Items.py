...
item_data_table[f"{progression_item_prefix}4"] = ARNFItemData(code = arnf_locations_start_id+normal_total_locations-1, amount_in_pool = 1, type=ItemClassification.progression)
item_data_table[f"{progression_item_prefix}7"] = ARNFItemData(code = arnf_locations_start_id+normal_total_locations, amount_in_pool = 1, type=ItemClassification.progression)
